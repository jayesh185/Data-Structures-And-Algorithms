class Solution {
public:
//this is the leetcode 486 . 
//done simply by dp . //we are taking our element and subtracting it with the maximum 
//that other playeer can get from remaining elements . 
